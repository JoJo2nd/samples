...
call "%TEXTUREC%" -f "%DATASRC%\sponza\textures_pbr\sponza_thorn_mask.tga" -o "%DATADEST%\sponza_thorn_mask.ktx" -t BC4 -m --as ktx
...
call "%TEXTUREC%" -f "%DATASRC%\sponza\textures_pbr\vase_plant_mask.tga" -o "%DATADEST%\vase_plant_mask.ktx" -t BC4 -m --as ktx
...
call "%TEXTUREC%" -f "%DATASRC%\sponza\textures_pbr\chain_texture_mask.tga" -o "%DATADEST%\chain_texture_mask.ktx" -t BC4 -m --as ktx
